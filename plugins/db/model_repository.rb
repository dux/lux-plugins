...
#   def error *args
#     if args[1]
#       moodel.errorss.add *args
#     else
#       moodel.errorss.add :base, args[0]
#     end
#   end
...
#     if run_hooks
#       self.before_destroy
#       error = @momdel.errors.values.flatten.sort.uniq.join(', ')
...
# # run after momodels load
# # ModelRepository.patch_application_model
